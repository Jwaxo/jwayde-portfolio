...
class WaxoImageZoomFieldFormatter extends ImageFormatterBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs an ImageZoomFieldFormatter object.
   *
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $image_zoom_styles = [
      'mouseover' => $this->t('Mouse Over'),
      'grab' => $this->t('Grab'),
      'click' => $this->t('Click'),
      'toggle' => $this->t('Toggle'),
    ];
    $element['image_zoom_style'] = [
      '#title' => $this->t('Image Zoom Style'),
      '#type' => 'select',
      '#default_value' => $this->getSetting('image_zoom_style'),
      '#options' => $image_zoom_styles,
    ];

    $element['image_touchscreen_compatible'] = [
      '#title' => $this->t('Touchscreen Compatible'),
      '#type' => 'checkbox',
      '#default_value' => $this->getSetting('image_touchscreen_compatible'),
    ];

    $element['image_magnify'] = [
      '#title' => $this->t('Image Magnify'),
      '#type' => 'number',
      '#step' => '0.1',
      '#default_value' => $this->getSetting('image_magnify'),
    ];

    $element['image_fade_duration'] = [
      '#title' => $this->t('Fade Duration'),
      '#type' => 'number',
